        ...
        <aside class="card">
            <section class="front">
                ...
                <footer>
                    ...
                    <p id="tagline"><span>Web</span>, <span>iOS</span>, <span>Android</span>, <span>IoT</span> and <span>XR</span> | Custom Development</p>
            ...
            <section class="back">
                ...
                <main>
                    ...
                    <p class="based">Based in Kâmpôt, Cambodia</p>
                    <p><img class="detail" src="components/tl-card/mail.svg"> <a href="mailto:thonly@heartbank.ceo">thonly@heartbank.ceo</a></p>
                    <p class="secondary"><a href="mailto:thonly@siliconwat.dev">thonly@siliconwat.dev</a></p>
                    <p title="Text Message or Voice Mail ONLY"><img class="detail" src="components/tl-card/voicemail.svg"> +1 (562) 726-2681</p>
                    <p class="alumni"><a href="mailto:thonly@ucla.edu">thonly@ucla.edu</a><br><a href="mailto:thonly@csu.fullerton.edu">thonly@csu.fullerton.edu</a><br><a href="mailto:thonly@hawaii.edu">thonly@hawaii.edu</a></p>
                </main>
                <footer>
                    ...
                    <a href="https://heartbank.ceo/#SiliconWat"><svg class="social" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#575F60" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path transform="rotate(45, 11, 11)" d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></a>
                </footer>
            </section>
        </aside>
    </div>
